...
export class CountMatchingV2Component implements OnInit {
  ...
  leftGroups: Group[] = [
    { id: 1, count: 2, emoji: '🍉', type: 'left', isSelected: false, isPaired: false, pairIndex: null },
    { id: 2, count: 5, emoji: '🍉', type: 'left', isSelected: false, isPaired: false, pairIndex: null },
    { id: 3, count: 7, emoji: '🍉', type: 'left', isSelected: false, isPaired: false, pairIndex: null },
  ];

  rightGroups: Group[] = [
    { id: 4, count: 5, emoji: '🍓', type: 'right', isSelected: false, isPaired: false, pairIndex: null },
    { id: 5, count: 2, emoji: '🍓', type: 'right', isSelected: false, isPaired: false, pairIndex: null },
    { id: 6, count: 7, emoji: '🍓', type: 'right', isSelected: false, isPaired: false, pairIndex: null },
  ];
